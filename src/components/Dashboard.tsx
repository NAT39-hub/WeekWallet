...
export const Dashboard: React.FC<DashboardProps> = ({ stats, isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-md border border-white/20 dark:border-gray-700/30 shadow-xl dark:shadow-2xl rounded-2xl p-6 transition-all duration-300 hover:shadow-lg dark:hover:shadow-blue-900/10">
